/*************************************************************************
 ...
 > Desc: Simple doubly linked list implementation by c.
 > Author: tiankonguse(skyyuan)
 > Mail: i@tiankonguse.com 
 > Created Time: 2016年06月24日
 ***********************************************************************/
 ...
 */
static inline void __list_add(struct list_head *p, struct list_head *prev, struct list_head *next){
    next->prev = p;
    p->next = next;
    p->prev = prev;
    prev->next = p;
...
/**
 *  delete list entry(head) and meger other to head
 *  @list the entry to splice
 *  @head he head that will follow our list
 */
